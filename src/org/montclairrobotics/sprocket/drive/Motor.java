...
public class Motor implements Updatable {
  ...
  /**
   * Sets the speed this motor should be imputed so that it turns at max speed If the robot has a
   * maximum speed of 3 ft/s, this should be 3 and the input should be in ft/s
   *
   ...
   */
  public Motor setPID() {
    if (pid != null && encRate != null) pid.setInput(encRate).setMinMax(0, 0, -1, 1);
    return this;
  }
  ...
  /**
   * Returns the speed to drive at Overwrite this method to use your own calculations Will be
   * converted to a percentage of maxSpeed; 1 if not set
   *
  ...
  /**
   * The automatically called function to update the speed of this wheel Will attempt to use a PID
   * controller if it is not null.
   */
  public void update() {
