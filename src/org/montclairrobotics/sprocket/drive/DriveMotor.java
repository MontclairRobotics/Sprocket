...
public class DriveMotor extends Motor {
  ...
  /**
   * Creates a DriveMotor Any optional field can be left as null
   *
  ...
  public DriveMotor(SpeedController motor, String name, Vector offset, Angle forceAngle) {
    ...
    if (forceAngle == null) this.forceAngle = new Degree(0);
  }
  /**
  ...
  /**
   * Sets the velocity Vector of the robot with a rotation value Calculates the goal Vector for this
   * one wheel and saves it to goal.
   *
  ...
  /**
   * Calculates the speed of this wheel Overload this method for more complicated driveTrains
   *
