...
/** @author Jack Hymowitz, Rafi Baum Runs all the modules which need to be updated in each tick */
public class Updater {
  ...
  private static TreeMap<Priority, ArrayList<Updatable>> objects =
      new TreeMap<Priority, ArrayList<Updatable>>(
  ...
  /**
   * Adds an object implementing Updatable to the list of objects that will be updated each tick.
   *
