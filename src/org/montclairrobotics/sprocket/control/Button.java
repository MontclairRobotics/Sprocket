 ...
 *
 * <p>It is recommended to create these as sub-classes in in a larger class
 *
...
public class Button implements Updatable {
  ...
  /**
   * Creates a Button on a given joystick and button id Call super(stick,buttonid) as the first line
   * of a constructor to attach the button
   *
  ...
  /**
   * Calls the events once per loop This creates the events which can be processed. This should be
