...
/**
 * @author Rafi Baum Extends the WPILib Joystick class by adding functionality such as an automatic
 *     deadzone
 */
public class SJoystick {
  ...
  /**
   * Sets a software deadzone for the joystick's control axes. If the absolute value of any joystick
   * reading is under the deadzone, that value is returned as a zero unless you opt to read the raw
   * value.
   *
  ...
  /**
   * Reads the joystick's raw position on the x axis without any software adjustment, such as the
   * deadzone. This is the same value you would get if you were to read from the WPILib Joystick
   * object.
   *
  ...
  /**
   * Reads the joystick's raw position on the y axis without any software adjustment, such as the
   * deadzone. This is the same value you would get if you were to read from the WPILib Joystick
   * object.
   *
  ...
  /**
   * Reads the joystick's raw position on the z axis without any software adjustment, such as the
   * deadzone. This is the same value you would get if you were to read from the WPILib Joystick
   * object.
   *
  ...
  /**
   * Gets the position of the joystick POV slider. If there are multiple POV sliders, it uses the
   * one with ID 0.
   *
   * @return Position of the POV slider
   */
